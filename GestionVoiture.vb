Public Class GestionVoiture
    ...
    Private Sub entrer_Button_Click(sender As Object, e As EventArgs) Handles entrer_Button.Click
        ...
        items = New String() {immatriculation_TextBox.Text, chaufeur_TextBox.Text, nbrplaces_TextBox.Text, GetMarque(), datedentrer_DatePicker.Text, datedesortie_DatePicker.Text}
    ...
    Function CheckInputs() As Boolean
        ...
        If Not IsNumeric(nbrplaces_TextBox.Text) Then
            'sexe
            valid = False

            nombreDePlace_underline_label.ForeColor = Color.Red
        End If
    ...
    Sub ResetColor()
        ...
        nombreDePlace_underline_label.ForeColor = Color.FromArgb(73, 80, 87)
    ...
    Private Sub nbrplaces_TextBox_Enter(sender As Object, e As EventArgs) Handles nbrplaces_TextBox.Enter
        error_label.Visible = False
        ResetColor()
    End Sub
    ...
    Private Sub GestionVoiture_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        error_label.Visible = False
        ResetColor()
    End Sub
